#
#  Be sure to run `pod spec lint SwiftBannerView.podspec' to ensure this is a
...
# Or just: s.author    = "LuKane"
# s.authors            = { "LuKane" => "1169604556@qq.com" }
...
s.source_files  = "SwiftBannerView", "SwiftBannerView/SwiftBannerView/**/*.{h,m}"
